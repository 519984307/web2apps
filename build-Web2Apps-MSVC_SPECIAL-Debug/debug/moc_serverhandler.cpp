...
#include "../../Web2Apps/serverhandler.h"
...
QT_MOC_LITERAL(3, 22, 13), // "QHttpRequest*"
QT_MOC_LITERAL(4, 36, 3), // "req"
QT_MOC_LITERAL(5, 40, 14), // "QHttpResponse*"
QT_MOC_LITERAL(6, 55, 4), // "resp"
QT_MOC_LITERAL(7, 60, 13), // "slotReadyRead"
QT_MOC_LITERAL(8, 74, 11) // "processPost"

    },
    "ServerHandler\0handle\0\0QHttpRequest*\0"
    "req\0QHttpResponse*\0resp\0slotReadyRead\0"
    "processPost"
};
...
void ServerHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handle((*reinterpret_cast< QHttpRequest*(*)>(_a[1])),(*reinterpret_cast< QHttpResponse*(*)>(_a[2]))); break;
        case 1: _t->slotReadyRead(); break;
        case 2: _t->processPost(); break;
        default: ;
        }
